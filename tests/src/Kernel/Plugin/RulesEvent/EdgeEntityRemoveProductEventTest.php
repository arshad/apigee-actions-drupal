...
class EdgeEntityRemoveProductEventTest extends EdgeEntityEventTestBase {
  ...
  public function testEvent() {
    ...
    $config_entity = $this->storage->create([
      'id' => 'app_insert_rule',
      'events' => [['event_name' => 'apigee_actions_entity_remove_product:developer_app']],
    ...
    $this->assertLogsContains("Event apigee_actions_entity_remove_product:developer_app was dispatched.");
