...
namespace Drupal\apigee_actions\EventSubscriber;
...
class AppCredentialEventSubscriber implements EventSubscriberInterface {
  ...
  public function onAddProduct(AppCredentialAddApiProductEvent $event) {
    $this->dispatchRulesEvent('apigee_actions_entity_add_product:developer_app', $event, $event->getNewProducts());
  }
  ...
  public function onRemoveProduct(AppCredentialDeleteApiProductEvent $event) {
    $this->dispatchRulesEvent('apigee_actions_entity_remove_product:developer_app', $event, [$event->getApiProduct()]);
  }
    ...
    try {
      ...
      foreach ($api_products as $product) {
        ...
        $api_product = $this->entityTypeManger
          ...
          ->load($product);
        $this->eventDispatcher->dispatch($rules_event_name, new EdgeEntityEvent($app, [
          $app_type => $app,
          'developer' => $developer,
